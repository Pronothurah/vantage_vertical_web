...
export default function TechnologyPage() {
  return (
    <main className="min-h-screen">
      ...
      {/* Revolutionary Drone Technologies */}
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-section-title mb-4">
              Revolutionary <span className="text-gradient">Drone Technologies</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h3 className="text-subsection-title mb-4">Advanced Sensor Technologies</h3>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Next-generation sensors enabling unprecedented data collection and analysis capabilities
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="service-card text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-3">LiDAR Mapping</h4>
                <p className="text-gray-600 text-sm mb-4">
                  High-precision 3D mapping and terrain modeling with centimeter-level accuracy
                </p>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Topographic surveys</li>
                  <li>• Forest canopy analysis</li>
              ...
              <div className="service-card text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 0h10m-9 0a2 2 0 00-2 2v14a2 2 0 002 2h8a2 2 0 002-2V6a2 2 0 00-2-2m-5 3h4" />
                  </svg>
                </div>
                <h4 className="text-lg font-bold text-gray-900 mb-3">Multispectral Imaging</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Advanced spectral analysis for crop health, vegetation monitoring, and environmental assessment
                </p>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• NDVI analysis</li>
                  <li>• Crop stress detection</li>
              ...
              <div className="service-card text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-3">Thermal Imaging</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Heat signature detection for search & rescue, energy audits, and wildlife monitoring
                </p>
                <ul className="space-y-1 text-xs text-gray-600">
              ...
              <div className="service-card text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-3">Gas Detection</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Environmental monitoring and hazardous gas detection for industrial safety
                </p>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Methane leak detection</li>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h3 className="text-subsection-title mb-4">Emerging Applications</h3>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Revolutionary use cases that are reshaping industries and creating new business opportunities
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Medical Delivery</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Life-saving medical supplies, blood products, and emergency medications delivered to remote areas
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 80% faster delivery to remote clinics</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Emergency blood delivery</li>
                  <li>• Vaccine distribution</li>
                  <li>• Remote area medical supply</li>
                </ul>
              </div>
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Disaster Response</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Rapid assessment, search & rescue operations, and emergency communication in disaster zones
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 60% faster victim location</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Climate Monitoring</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Real-time environmental data collection for climate research and conservation efforts
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 90% more data points collected</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Carbon emission tracking</li>
                  <li>• Deforestation monitoring</li>
                  <li>• Ocean temperature mapping</li>
                </ul>
              </div>
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Smart Infrastructure</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Automated infrastructure monitoring and maintenance for smart city development
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 50% reduction in maintenance costs</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Bridge & road inspection</li>
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">3D Construction</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Automated construction using 3D printing drones for building structures and infrastructure
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 70% faster construction time</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• 3D printed buildings</li>
              ...
              <div className="service-card">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Autonomous Farming</h4>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  Fully automated farming operations including seeding, spraying, and harvesting
                </p>
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  <p className="text-xs text-gray-700 font-semibold">Impact: 40% increase in crop yields</p>
                </div>
                <ul className="space-y-1 text-xs text-gray-600">
                  <li>• Precision seeding</li>
                  <li>• Automated spraying</li>
