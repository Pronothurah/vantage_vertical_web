...
export const EMAIL_CONFIG = {
   ...
   */
  CONTACT_EMAIL: (process.env.CONTACT_EMAIL && process.env.CONTACT_EMAIL.trim()) || 'vantageverticalltd@gmail.com',
  
  /**
   * SMTP sender email address used for outgoing emails
   */
  SMTP_FROM: (process.env.SMTP_FROM && process.env.SMTP_FROM.trim()) || 'vantageverticalltd@gmail.com',
